...
public abstract class Documentt {
	...
	{
		int Vowels = getTextTokens(word, "[aeiouyAEIOUY]+").size();
		int notVowels = getTextTokens(word, "[aeiouyAEIOUY]+").size();
	...
	protected abstract boolean isAVowel(char charAt);

	protected abstract List<String> getTextTokens(String word, String string);
	...
	public double getFleschScore()
	{
		double numWords =  getNumWords();
			 ...
			 double getsentence = getNumSentences();
			
			 double getsyllables =  getNumSyllables();
	    return 206.835 -1.015*(numWords/getsentence)-84.6*(getsyllables/numWords);
	}
